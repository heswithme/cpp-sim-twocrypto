...
DEFAULT_DATAFILE = "python/arb_sim/trade_data/xauusd/xauusd-2020-latest.json"
...
BASE_POOL = {
    ...
    "ma_time": int(86400 / math.log(2)), #866
...
BASE_COSTS = {
    "arb_fee_bps": 25.0, # 0.25 redemption fee
    "gas_coin0": 0.0,
