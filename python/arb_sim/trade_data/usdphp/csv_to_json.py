...
- Input:  arb_sim/trade_data/usdphp/usdphp.csv
- Output: arb_sim/trade_data/usdphp/usdphp-1m.json
"""
...
INPUT_CSV = Path(__file__).parent / "usdphp.csv"
OUTPUT_JSON = Path(__file__).parent / "usdphp-1m.json"
